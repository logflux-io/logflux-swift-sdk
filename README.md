...
```swift
dependencies: [
    .package(url: "https://github.com/logflux-io/logflux-swift-sdk.git", from: "3.0.1")
]
```
...
[Elastic License 2.0 (ELv2)](LICENSE) -- free for all use except offering as a hosted or managed service to third parties.
